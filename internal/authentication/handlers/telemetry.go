...
var authenticationRequestTelemetry = map[string]requestTelemetry{
	...
	http.MethodPost + " /api/auth/sign-out": requestDetails(
		"user.sign_out",
	...
	http.MethodGet + " /api/auth/session": requestDetails(
		"user.session.load",
	...
	http.MethodPost + " /api/auth/revoke-other-sessions": requestDetails(
	...
	http.MethodPost + " /api/auth/revoke-sessions": requestDetails(
	...
	http.MethodPost + " /api/auth/change-password": requestDetails(
	...
	http.MethodPost + " /api/auth/set-password": requestDetails(
		"user.password.set",
	...
	http.MethodPost + " /api/auth/remove-password": requestDetails(
	...
	http.MethodPost + " /api/auth/verify-email": requestDetails(
		"user.email.verify",
	...
	http.MethodPost + " /api/auth/forgot-password": requestDetails(
	...
	http.MethodPost + " /api/auth/reset-password": requestDetails(
